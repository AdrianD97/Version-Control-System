    ...
    public void run() {
        ...
        while (true) {
            ...
            if (!wasError && this.isTrackable(operation)) {
                // generez un mesaj corespunzator operatiei executate.
                String message = FactoryMessageOperation.getInstance().create(operation);
                // adaug mesajul la stagin-ul branch-ului curent al vcs-ului.
                vcs.getCurrentBranch().getStaging().add(message);
            }
        }
    }
