...
public final class OperationParser {
    ...
    private AbstractOperation parseVcsOperation(String newOperation,
        ...
        operationArgs.remove(0); // sterg sirul "vcs".
        ...
        switch (specificCommand.toLowerCase()) {
            ...
            case "commit":
                String first = operationArgs.remove(0);
                String message = String.join(" ", operationArgs);
                operationArgs.clear();
                operationArgs.add(first);
                operationArgs.add(message);
